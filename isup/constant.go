...
// Q931 Bearer Capabilities (for User Service Information)
var CodingStandardValues = map[uint8]string{
...
var TransferCapabilityValues = map[uint8]string{
	0x00: "Speech",
...
var TransferModeValues = map[uint8]string{
	0x00: "Circuit mode",
	0x01: "Packet mode",
}

var TransferRateValues = map[uint8]string{
...
var UserInfoLayer1Values = map[uint8]string{
	0x00: "ITU-T standardized rate adaption V.110, I.460 and X.30",
	0x02: "G.711 u-law",
	0x03: "G.711 a-law",
	0x04: "G.721 ADPCM",
